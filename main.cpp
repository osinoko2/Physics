...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	while (Novice::ProcessMessage() == 0) {
		...
		ImGui::Begin("window");
		ImGui::SliderFloat("HalfApexAngle", &conicalPendulum.halfApexAngle, -1.5f, 1.5f);
		ImGui::End();
		...
		DrawLine(conicalPendulum.anchor, sphere.center, viewProjectionMatrix, viewportMatrix, WHITE);
